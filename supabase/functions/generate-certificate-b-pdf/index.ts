...
// ══════════════════════════════════════════════════════════════════════════════
// PDF Primitives (mismo patrón que generate-contract-pdf)
// ══════════════════════════════════════════════════════════════════════════════
...
// Tabla de anchos de carácter Helvetica (Regular y Bold) en 1/1000 de em.
// Fuente: Adobe Glyph List / PDF spec Annex D.
...
/** Ancho exacto en puntos para texto Helvetica Regular o Bold. */
...
// ──────────────────────────────────────────────────────────────
// PNG loader → PdfImage (idéntico a generate-class-book-pdf)
// ──────────────────────────────────────────────────────────────
...
// ══════════════════════════════════════════════════════════════════════════════
// PDF Assembler (con soporte opcional de imagen)
// ══════════════════════════════════════════════════════════════════════════════
