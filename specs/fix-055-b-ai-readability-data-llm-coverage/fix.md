...
## Cambio
- **Alcance reducido, a pedido del owner** (se detuvo el trabajo en solitario para repartirlo en el equipo — ver `specs/ASSIGNMENTS.md` ASG-b-002..ASG-b-005). De los 35 archivos originales:
