...
## Root Cause
[Heredado de ASG-b-006, a confirmar]: Tercer lote de cobertura `data-llm-*` (ver
...
- **Archivo:** `src/app/shared/components/async-btn/async-btn.component.ts` — nota especial de
  ASG-b-006: es un botón wrapper genérico; si `data-llm-action` depende del contexto de uso,
