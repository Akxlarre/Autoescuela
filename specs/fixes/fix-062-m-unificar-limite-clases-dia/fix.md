...
## ACs Afectados
- Ninguno de spec — hallazgo H-021 (`indices/FLOWS-QA-AUDIT.md`), gestionado como Asignación de equipo (ASG-b-023).
...
## Notas
- Originado de Asignación ASG-b-023 (`specs/assignments/ASG-b-023-decision-h021-limite-clases-dia.md`).
