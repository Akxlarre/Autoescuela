...
| ASG-b-087 | Listas sin techo: filtro de período por defecto + búsqueda/export deben ignorarlo + límite en Deudores | `cualquiera` | fix | Media | b | Investigación en `docs/research/listas-grandes-virtual-scroll.md` §5.1. NO incluye virtual scroll (ver ASG-b-088) |
| ASG-b-088 | Investigación empírica: simular datos y validar el umbral de virtual scroll | `cualquiera` | spec | Baja | b | Continuación de ASG-b-087. Sembrar datos sintéticos + benchmark antes de implementar nada — no bloquea ASG-b-087 |
