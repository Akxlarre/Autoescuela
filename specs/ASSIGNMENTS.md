...
|----|--------|----------------|-------------------|-------|
| ASG-019 | Fix H-038: columna "Clases activas" de Instructores siempre muestra 0 — nunca se escribe | `m` | [fix-072-m-instructores-clases-activas-count](fix-072-m-instructores-clases-activas-count/fix.md) | 2026-07-27 |
