...
|----|--------|----------------|-------------------|-------|
| ASG-b-073 | App-like: familia "servicios especiales" (`admin` + `secretaria`) | `i` | [fix-021-i-app-like-servicios-especiales](fixes/fix-021-i-app-like-servicios-especiales/fix.md) | 2026-08-08 |
<!-- AUTO-GENERATED:END -->
