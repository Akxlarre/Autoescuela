# Asignación ASG-037 — Cuadratura editable + egresos de combustible por vehículo
...
- ⚠️ **Se solapa con ASG-039** (botón de registrar egreso en el dashboard), que es la parte
  desbloqueada del mismo tema. Coordinar para no duplicar el formulario de egreso: conviene
  que ASG-039 cree el componente reutilizable y esta asignación lo consuma.
