...
- ⚠️ **Se solapa con ASG-b-024** (el buscador global no indexa alumnos). Si el número de
  matrícula pasa a ser el identificador principal, el buscador **tiene** que encontrarlo por
  ese número. Coordinar.
- ⚠️ **Se solapa con ASG-b-045** (imprimir libro de Registro de Alumnos), que gira en torno a la
