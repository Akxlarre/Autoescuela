# Asignación ASG-045 — Imprimir lista de alumnos (réplica del libro de Registro de Alumnos)
...
- ⚠️ **Se solapa con ASG-049** (número de matrícula como dato principal): las dos giran en
