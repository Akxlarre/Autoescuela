# Asignación ASG-b-032 — Fix H-036: flash de texto incorrecto en Pagos de alumno Clase B
...
- Fix trivial, un solo archivo — buen candidato para alguien con poco tiempo. Considerar agruparlo junto con **ASG-b-005** si la misma persona ya está tocando `alumno-pagos` por otro motivo (no hay overlap de archivo hoy, pero es un área relacionada).
