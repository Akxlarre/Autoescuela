# Asignación ASG-048 — Secretaría no debe ver calificación ni aspectos a evaluar en Iniciar Clase
...
- ⚠️ **Se solapa con ASG-036** (ciclo de vida de la clase), que toca la misma pantalla y el
