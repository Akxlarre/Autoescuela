# Asignación ASG-050 — Poder borrar (¿o anular?) Servicios Especiales
...
2. Si se borra una venta pagada, **¿qué pasa con la cuadratura del día en que se cobró?**
   Es el mismo problema que ASG-037: la cuadratura guarda `total_expenses`/ingresos como
...
- ⚠️ Tocando el mismo nervio que **ASG-037** (¿se puede modificar el pasado financiero?). Si el
