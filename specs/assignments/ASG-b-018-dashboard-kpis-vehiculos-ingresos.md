# Asignación ASG-b-018 — Fix H-001 + H-002 + H-008: Dashboard admin — KPIs y estados
...
> **resulting_track:** fix-063-b-dashboard-kpis-estados
...
- ⚠️ **Coordinar con ASG-b-005** (cobertura `data-llm-*`, también toca `dashboard.component.ts`) — avisarse antes de editar en paralelo.
