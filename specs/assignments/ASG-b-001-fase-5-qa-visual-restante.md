...
- Coordinar con **ASG-b-022** (fix de skeletons en Agenda/Libro de Clases, H-007) — esta asignación es la verificación, ASG-b-022 es el fix del bug ya confirmado. No dupliquen el diagnóstico.
