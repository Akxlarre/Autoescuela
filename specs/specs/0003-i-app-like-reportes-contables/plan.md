...
- [ ] `visual-system.md` — Tokens, bento grid, patrón app-like (fill-screen/tabs)
...
- QA manual (golden path + edge cases): `/verify` en las 4 rutas (`admin`/`secretaria` ×
  desktop/mobile), 390×844, 1440×900 y 768 de alto.
...
|--------|--------------|------------|
| Perder algún reporte de las 7 secciones al reagrupar en tabs | Media | Catalogar las 784 líneas completas antes de tocar código |
