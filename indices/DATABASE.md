...
> Ciclos teóricos Clase B (Spec 0001-m): cohorte de 2 semanas, 6 clases L/X/V. '
...
> Clases de un ciclo teórico Clase B (Spec 0001-m): 6 por ciclo (L/X/V × 2 semanas). '
...
> Canal estructurado de comunicación multi-rol: admin↔secretary, secretary→instructor. '
  'Reemplaza secretary_observations. Spec 0001-m.
