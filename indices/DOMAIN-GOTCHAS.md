...
### DG-084 — El arqueo de caja solo cuadra contra EFECTIVO; `cash_closings.total_expenses` mezcla todos los métodos de pago
...
### DG-085 — Un canal Realtime con varios `postgres_changes` muere entero si UNA de sus tablas no está en `supabase_realtime`
