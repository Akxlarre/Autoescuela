...
- **Fuente:** `specs/fix-028-m-clase-b-consecutive-issues`
...
- **Fuente:** `specs/fix-059-b-nota-examen-final`
...
- **Fuente:** `specs/fix-063-b-dashboard-kpis-estados`
...
- **Fuente:** `specs/fix-053-m-libro-clases-promocion-id`
...
- **Fuente:** `specs/fix-072-m-instructores-clases-activas-count`
...
- **Fuente:** `specs/fix-053-b-ciclos-queries-limit`
...
- **Fuente:** `specs/fix-064-m-base-alumnos-b-columna-sede`
...
- **Fuente:** `specs/fix-056-b-reportes-contables-branch-id`
...
- **Fuente:** `specs/fixes/hotfixes/hotfix-044-m-trigger-dropout-recursion-infinita`
...
- **Fuente:** `specs/fixes/hotfixes/hotfix-012-m-class-b-sessions-updated-at`
...
- **Fuente:** `specs/fix-027-b-aislamiento-sede-secretaria`. **NUNCA tocar la RLS de `users` para "arreglar" esto** — reintroduce la regresión de fix-002.
...
- **Fuente:** `specs/fix-054-m-h028-rls-secretaria-documentos-profesional`
...
- **Fuente:** `specs/fix-060-m-h027-alertas-asistencia-profesional-sede`, `specs/fix-061-m-students-rls-branch-visible-performance`
...
- **Fuente:** `specs/fix-067-b-regresion-instructores-desaparecen-sin-branch-filter`
...
- **Fuente:** `specs/fix-066-b-admin-no-aparece-en-selector-de-secretaria`
...
- **Fuente:** `specs/fix-071-m-anticipos-no-reactivo-a-sede`, `specs/fix-063-m-reprogramar-clase-instructores-todas-sedes`, `specs/fix-022-m-incorporar-modal-polish`
...
- **Fuente:** `specs/fix-028-b-gating-profesional-sede-sin-profesional`, `specs/fix-029-b-guard-ruta-profesional-sede`
...
- **Fuente:** `specs/fix-013-b-menor-17-profesional-mensaje`, `specs/fix-014-b-getAgeStatus-compartido`
...
- **Fuente:** `specs/fix-031-m-revertir-restriccion-orden-class-number` (contexto: `specs/fix-030-m-reprogramar-clase-limite-superior`)
...
- **Fuente:** `specs/fix-017-m-clase-b-siempre-12-clases`
...
- **Fuente:** `specs/fix-062-m-unificar-limite-clases-dia`
...
- **Fuente:** `specs/fix-075-m-instructores-clases-activas-scope-hoy`, `specs/fix-076-m-dashboard-finalizar-clase-en-curso`, `specs/fix-077-m-secretaria-dashboard-finalizar-clase-en-curso`
...
- **Fuente:** `specs/fix-082-m-clases-b-vuelven-ocupadas-al-volver-paso2`
...
- **Fuente:** `specs/fix-066-m-drafts-en-base-alumnos`
...
- **Fuente:** `specs/fix-058-b-pago-multiples-matriculas`
...
- **Fuente:** `specs/fix-057-m-registrar-pago-monto-excesivo-silencioso`
...
- **Fuente:** `specs/fix-059-m-metodos-pago-porcentaje-redondeo`
...
- **Fuente:** `specs/fix-036-m-km-inicial-cero-permitido`
...
- **Fuente:** `specs/fixes/hotfixes/hotfix-030-m-dashboard-clase-hora-incorrecta`
...
- **Fuente:** `specs/fix-084-m-unificar-tablas-alumnos-exalumnos`
...
- **Fuente:** `specs/fixes/hotfixes/hotfix-019-b-limpieza-deuda-rbac-roleservice-hasrole`
