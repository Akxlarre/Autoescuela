...
| `/instructor/ensayos-teoricos` | `InstructorEnsayosTeoricosComponent` | **✅ Cerrado 2026-08-11 (fix-139-b / ASG-b-078).** hero + 1 `.bento-banner` con tabla de historial (loading/empty/data), sin paginación | `--fill-screen` singular, `.bento-fill` en la banner, tabla `flex-1 min-h-0 overflow-y-auto`, empty-state centrado en wrapper `flex-1 flex items-center justify-center` | Baja (cerrado) |
