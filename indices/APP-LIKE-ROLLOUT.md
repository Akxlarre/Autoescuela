...
14. **Familia "reportes contables"**: `/admin/contabilidad/reportes` + `/secretaria/...`
    **✅ Cerrado 2026-08-25 (spec 0003-i)**. `/admin/contabilidad/cuadratura` + `/secretaria/...`
    queda en spec separada (`0004-i-app-like-cuadratura`) — se dividieron en 2 specs a pedido
    del usuario en vez de un track conjunto (antes agrupadas en `ASG-b-082`).
