...
**Datos académicos:** curso en que te matriculaste, asistencia, horas teóricas y prácticas cursadas,
evaluaciones, observaciones de tu instructor y resultado del curso.
...
Si eres menor de edad, tu matrícula requiere la **autorización notarial de tu padre, madre o
representante legal**, quien también ejerce tus derechos sobre estos datos. Tratamos los datos de
menores con especial resguardo.
...
**Organismos públicos a los que informamos por mandato legal:**
...
y **retirar tu consentimiento** en cualquier momento, escribiendo a **conductorchillan@gmail.com**.
...
conservarlos (por ejemplo, el libro de registro de alumnos y la documentación tributaria). Si es tu
caso, te lo explicaremos indicando la norma concreta.
...
Los datos nos los entregas tú directamente al preinscribirte o matricularte. Si eres menor de edad, los
entrega además tu representante legal. No obtenemos datos tuyos desde fuentes de terceros.
