...
> expedito, gratuito y permanente. **La carga de la prueba del consentimiento es del responsable.**
>
> Estos textos van literalmente en los formularios de la aplicación y en la ficha de matrícula en papel.

---

## 1. Aviso corto — formulario de preinscripción en línea

Va junto al formulario, visible **antes** de enviar:

> Los datos que nos entregas (nombre, RUT, correo y teléfono) los trata **Jorge Enrique Pérez Godoy
> Capacitación y Servicios EIRL**, RUT 76.007.217-6, para contactarte y gestionar tu preinscripción en el
> curso que elegiste. Si no concretas la matrícula, los eliminamos a los 12 meses. Puedes ejercer tus
> derechos escribiendo a otecchillan@gmail.com. Más detalles en nuestra
> [Política de Privacidad](/politica-privacidad/autoescuela-chillan).

## 2. Consentimiento en la preinscripción (casilla NO premarcada)
...
## 3. Matrícula — aviso y consentimiento

En la ficha de matrícula (en línea y en papel), junto a la firma del contrato:

> Al matricularte, **Jorge Enrique Pérez Godoy Capacitación y Servicios EIRL** tratará tus datos de
> identificación, contacto, académicos, de pago y los documentos de tu expediente para impartirte el
> curso, certificar tu egreso y cumplir las obligaciones que la normativa nos impone, incluida la
> rendición ante SENCE cuando corresponda. Conservamos tu información 5 años desde tu egreso o baja.
> Detalle completo en la [Política de Privacidad](/politica-privacidad/autoescuela-chillan), que declaras haber leído.

> ☐ Declaro haber leído la Política de Privacidad de Jorge Enrique Pérez Godoy Capacitación y Servicios EIRL.
...
Cuando el alumno es menor de edad, **todos** los consentimientos anteriores los otorga su padre, madre o
...
Texto a entregar al trabajador al inicio del curso:

> Tu empleador, **[nombre de la empresa]**, contrató este curso e inscribió tus datos (nombre, RUT,
> correo y cargo) con nosotros. Nosotros, **Jorge Enrique Pérez Godoy Capacitación y Servicios EIRL**,
> RUT 76.007.217-6, tratamos esos datos para impartirte el curso y certificarte.
>
> **Le informaremos a tu empleador tu asistencia y tu resultado del curso**, que es lo que necesita para
> rendir la capacitación. No le entregaremos ningún otro dato tuyo.
>
...
es inmediato y gratuito."*

La vía de revocación es escribir a **otecchillan@gmail.com**. Retirar el
...
| Campo | Detalle |
|---|---|
| Titular | RUT y nombre |
| Qué aceptó | Preinscripción / matrícula / **certificado médico** / marketing |
| Cuándo | Fecha y hora |
| Cómo | En línea (con dirección IP) o en papel (ficha firmada, escaneada al expediente) |
| Versión de la política | La vigente al momento de aceptar (ej. "v1.0 — 16-08-2026") |
