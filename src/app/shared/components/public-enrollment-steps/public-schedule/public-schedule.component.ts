  ...
  styles: [
    `
      ...
      :host ::ng-deep .instructor-select-panel {
        ...
        box-shadow: 0 12px 32px -4px rgba(0, 0, 0, 0.08), 0 4px 12px -4px rgba(0, 0, 0, 0.04) !important; /* Sombra difusa y elegante */
      ...
      :host ::ng-deep .instructor-select-panel .p-select-option:not(.p-select-option-selected):not(.p-disabled):hover {
    ...
    <div class="space-y-5">
      <div>
        ...
        <p class="text-sm" style="color: var(--text-secondary);">
          ...
          clases prácticas para comenzar. Máximo {{ data().slotSelection.maxClassesPerDay }} por día.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-1.5">
        ...
        <p-select
          ...
          optionLabel="name"
          optionValue="id"
          [placeholder]="(loading() && data().instructors.length === 0) ? 'Cargando instructores disponibles...' : '— Selecciona un instructor —'"
      ...
      @if (insufficientAvailability()) {
        ...
        >
          ...
          <span>
            ...
            {{ data().slotSelection.requiredCount }} clases (máximo {{ data().slotSelection.maxClassesPerDay }} por día). Elige otro
      ...
      @if (!data().instructorId) {
        ...
        >
          <app-icon name="loader" class="animate-spin mb-3" [size]="32" color="var(--text-secondary)" />
          <p class="text-sm font-semibold" style="color: var(--text-primary);">Cargando horario...</p>
          <p class="text-xs mt-1" style="color: var(--text-secondary);">Buscando disponibilidad del instructor</p>
        </div>
        ...
        >
          @if (data().scheduleLoading) {
            <!-- Spinner superpuesto -->
            <div class="absolute inset-0 z-10 flex flex-col items-center justify-center rounded-xl" style="background: rgba(255,255,255,0.4); backdrop-filter: blur(1px);">
