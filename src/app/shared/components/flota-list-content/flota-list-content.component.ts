                  ...
                  <tr class="hover:bg-subtle transition-colors border-b border-border-subtle">
                    ...
                    <td>
                      <div class="flex items-center gap-2">
                        <div
                          class="w-8 h-8 rounded-full bg-elevated flex items-center justify-center border border-border-subtle text-text-secondary font-bold text-xs"
                        >
                          {{ v.instructorName ? v.instructorName.charAt(0) : '?' }}
                        </div>
                        <span class="text-xs text-text-secondary">{{
                          v.instructorName || 'Sin asignar'
                        }}</span>
                      </div>
                    </td>
...
export class FlotaListContentComponent {
  ...
  onTypeChange(v: VehicleType | null): void {
    this.typeFilterChange.emit(v);
  }
