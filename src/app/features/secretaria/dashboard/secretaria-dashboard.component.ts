  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Dashboard Secretaria</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /secretaria/dashboard</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs text-text-muted"> mock/web/src/pages/secretaria/dashboard.astro </code>
      </div>
    </div>
  `,
})
