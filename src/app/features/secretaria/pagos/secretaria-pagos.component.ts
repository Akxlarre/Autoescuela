    ...
    <div class="bento-grid" appBentoGridLayout #bentoGrid>
      ...
      <div class="bento-banner">
        <div class="flex flex-col gap-6">
                ...
                @if (totalPaginasDeudores() > 1) {
                  ...
                  >
                    <span class="text-xs text-text-muted"
                      >{{ rangoDeudoresMostrando() }} alumnos</span
                    >
          ...
          <!-- Pagos Recientes + Métodos de Pago -->
          <div
            ...
            <div class="lg:col-span-8 card p-0 overflow-hidden" appCardHover>
              ...
              @if (facade.isLoading()) {
                <div class="rows-divider">
                  @for (row of [1, 2, 3, 4, 5]; track row) {
                    ...
                    >
                      ...
                      <div class="flex flex-col lg:contents gap-1">
                      ...
                      >
                        ...
                        <app-skeleton-block
                          ...
                          width="80%"
                          height="12px"
                          class="col-span-2 lg:col-span-1 mt-1 lg:mt-0"
                        />
                      </div>
                      <app-skeleton-block
                        variant="rect"
                ...
                <div
                  class="px-6 py-3 flex items-center justify-between border-t border-border-muted"
                >
                  <span class="text-xs text-brand">{{ rangoMostrando() }}</span>
                  <div class="flex gap-2">
                    <button
                      class="btn-outline"
