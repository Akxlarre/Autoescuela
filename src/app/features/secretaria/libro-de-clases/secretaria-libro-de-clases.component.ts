  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Libro de Clases</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /libro-de-clases (raíz)</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs text-text-muted"> mockop/web/src/pages/libro-de-clases.astro </code>
      </div>
    </div>
  `,
})
export class SecretariaLibroDeClasesComponent {}
