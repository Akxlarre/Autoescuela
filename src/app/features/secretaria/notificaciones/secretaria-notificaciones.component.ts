...
@Component({
  selector: 'app-secretaria-notificaciones',
    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          ...
          <p class="text-sm text-text-muted mt-0.5">Mockup: /secretaria/notificaciones</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mockup/web/src/pages/secretaria/notificaciones.astro
        </code>
      </div>
    </div>
  `,
})
export class SecretariaNotificacionesComponent {}
