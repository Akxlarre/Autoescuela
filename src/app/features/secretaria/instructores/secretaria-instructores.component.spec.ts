...
import { SecretariaInstructoresComponent } from './secretaria-instructores.component';
...
describe('SecretariaInstructoresComponent — densidad app-like (fix-125-b)', () => {
  let component: SecretariaInstructoresComponent;
  ...
  function setup(): void {
    ...
    TestBed.configureTestingModule({
      imports: [SecretariaInstructoresComponent],
      providers: [
        {
    ...
    component = TestBed.createComponent(SecretariaInstructoresComponent).componentInstance;
  }
