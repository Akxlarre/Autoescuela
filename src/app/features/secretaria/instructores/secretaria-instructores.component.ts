...
export class SecretariaInstructoresComponent implements OnInit {
  ...
  protected readonly mobileShown = signal(SecretariaInstructoresComponent.CARDS_STEP);
  ...
  protected setFilter(filter: FilterTab): void {
    ...
    this.mobileShown.set(SecretariaInstructoresComponent.CARDS_STEP);
  }

  protected loadMoreCards(): void {
    this.mobileShown.update((n) => n + SecretariaInstructoresComponent.CARDS_STEP);
  }
