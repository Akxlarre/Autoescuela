  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Mis Alumnos</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /instructor/alumnos</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mockup/web/src/pages/instructor/alumnos.astro
        </code>
      </div>
    </div>
  `,
})
export class InstructorAlumnosComponent {}
