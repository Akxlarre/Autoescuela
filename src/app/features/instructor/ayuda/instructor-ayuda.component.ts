    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          ...
          <p class="text-sm text-text-muted mt-0.5">Mockup: /instructor/ayuda</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mockop/web/src/pages/instructor/ayuda.astro
        </code>
      </div>
    </div>
  `,
})
export class InstructorAyudaComponent {}
