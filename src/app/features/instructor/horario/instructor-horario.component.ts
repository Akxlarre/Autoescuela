  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Mi Horario</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /instructor/horario</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mockup/web/src/pages/instructor/horario.astro
        </code>
      </div>
    </div>
  `,
})
export class InstructorHorarioComponent {}
