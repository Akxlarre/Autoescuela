            ...
            <div class="bento-card relative overflow-hidden">
              ...
              <div class="flex items-start sm:items-center gap-4 mb-5 relative z-10">
                ...
                <div class="flex-1 min-w-0">
                  <h2 class="text-xl font-display font-bold text-text-primary truncate">
                    {{ cls.studentName }}
                  </h2>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="min-w-0">
                    ...
                    <p class="text-sm text-text-primary font-medium truncate">
                      {{ cls.vehiclePlate }}
                      <span class="text-text-muted font-normal">({{ cls.vehicleLabel }})</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <div class="flex flex-col items-center justify-center relative z-10">
                    <div
                      class="w-16 h-16 rounded-full bg-brand/10 text-brand flex items-center justify-center mb-6 shadow-sm ring-1 ring-brand/20 group-focus-within:scale-110 group-focus-within:bg-brand group-focus-within:text-white transition-all duration-500"
                    >
                      <app-icon name="gauge" [size]="32" />
                    </div>

                    <label
                      class="text-sm font-bold text-text-secondary uppercase tracking-widest mb-2 cursor-pointer"
                      for="kmStart"
                    >
                      Kilometraje Actual
                    </label>
                    ...
                    @if (startForm.get('kmStart')?.invalid && startForm.get('kmStart')?.touched) {
                      <div
                        class="mt-4 flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-error/10 text-error text-sm font-medium animate-in fade-in slide-in-from-top-2"
                      >
