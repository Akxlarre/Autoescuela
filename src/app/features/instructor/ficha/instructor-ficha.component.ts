...
@Component({
    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Ficha del Alumno</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /instructor/ficha/[id]</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mock/web/src/pages/instructor/ficha/[id].astro
        </code>
      </div>
    </div>
  `,
})
export class InstructorFichaComponent { }
