...
@Component({
  ...
  template: `
    <div class="px-4 md:px-6 py-6 pb-20 max-w-5xl mx-auto space-y-6">
      <!-- ── Error ── -->
      @if (facade.error()) {
          ...
          <div class="card p-0 overflow-hidden">
            ...
            <div class="p-4">
              <app-alert-card
                ...
                [dismissible]="false"
              >
                Puedes evaluar las clases completadas haciendo clic en <strong>Evaluar</strong>. Las
                clases ya evaluadas se pueden revisar con <strong>Ver Detalles</strong>.
              </app-alert-card>
            </div>
          </div>
        }
