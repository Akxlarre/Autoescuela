        ...
        <table class="tabla-ficha w-full">
          <thead>
            <tr>
              ...
              <th scope="col" class="sticky top-0 z-10 text-center no-print">Acción</th>
            </tr>
          </thead>
          <tbody>
              ...
              >
                ...
                <td>
                  <span
                    ...
                    [class.text-brand]="clase.instructor"
                    [class.text-text-muted]="!clase.instructor"
                  >
                ...
                <td>
                  <div class="flex items-center justify-center gap-2">
                    <div
                      class="firma-dot group-hover:scale-110 transition-transform shadow-sm"
                ...
                <td class="text-center no-print">
                  @if (!clase.completada) {
                    <button
                      ...
                      data-llm-action="reprogramar-clase"
                      (click)="reprogramarRequested.emit(clase)"
                    >
