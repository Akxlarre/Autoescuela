...
/**
 * DmsStudentDocsDrawerComponent — Drawer con la lista de documentos de un alumno.
 * Reemplaza la antigua subruta de página completa /documentos/alumnos/:id.
 * Click en un documento → facade.openDocPreview() apila (push) el visor sobre esta lista;
 * el botón "volver" del header del drawer regresa aquí (LayoutDrawerService.canGoBack).
 */
@Component({
  selector: 'app-dms-student-docs-drawer',
  standalone: true,
...
export class DmsStudentDocsDrawerComponent {
