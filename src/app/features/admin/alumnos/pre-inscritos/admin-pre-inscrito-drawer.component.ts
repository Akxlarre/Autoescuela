    ...
    @if (facade.selected(); as p) {
      ...
      <div class="flex gap-0 mb-6" style="border-bottom: 1px solid var(--border-subtle)">
        <button
          ...
          [class.text-text-secondary]="activeTab() !== 'datos'"
          [class.text-text-primary]="activeTab() === 'datos'"
        ...
        <button
          ...
          [class.text-text-secondary]="activeTab() !== 'test'"
          [class.text-text-primary]="activeTab() === 'test'"
        ...
        >
          ...
          @if (p.psychResult === null) {
            <span class="absolute top-2 right-1 w-2 h-2 rounded-full" class="bg-warning"></span>
          }
        </button>
        ...
        <button
          ...
          "
          [class.text-text-primary]="activeTab() === 'matricula'"
                ...
                @if (p.isVencido) {
                  ...
                  >
                    ...
                    <p class="text-sm text-danger">
                      Pre-inscripción vencida. No puede completarse.
                    </p>
                  </div>
                }
              </div>
                  ...
                  >
                    <div class="flex items-center gap-3">
                      <app-icon
                        ...
                        [size]="18"
                        [color]="
                          p.psychResult === 'fit' ? 'var(--color-success)' : 'var(--color-danger)'
                        "
                      />
                      <div>
              ...
              <div class="space-y-4" #tabContent>
                @if (p.status !== 'approved' && p.status !== 'pending_contract') {
                  ...
                  <div class="card space-y-4">
                    ...
                    <div
                      class="flex items-center justify-between gap-3 rounded-lg p-3 border border-border-subtle bg-elevated"
                    >
                      <div class="flex items-center gap-3">
                        <app-icon
                          ...
                          [size]="18"
                          [color]="
                            contractPdfUrl() ? 'var(--color-success)' : 'var(--color-text-muted)'
                          "
                        />
                        <div>
                    ...
                    @if (contractPdfUrl()) {
                      ...
                      <div class="space-y-2">
                        ...
                        @if (!signedContractFile()) {
                          <label
                            class="flex flex-col items-center justify-center gap-2 border-2 border-dashed rounded-xl p-5 cursor-pointer transition-colors border-border-default"
                      ...
                      >
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                          ...
                          <label
                            ...
                            "
                            [style.color]="
                              docFileSignal(doc.key)() ? 'var(--color-success)' : undefined
                            "
                  ...
                  <div class="card space-y-4">
                    ...
                    <div class="rounded-xl p-4 space-y-2 bg-text-primary">
                      <div
                    ...
                    @if (formDiscountAmount() > 0) {
                      ...
                      <div class="space-y-2">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                          ...
                          <button
                            type="button"
                            class="btn-secondary text-xs col-span-2"
