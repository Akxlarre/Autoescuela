...
/**
 * EnviarMasivoDrawerComponent — Smart / Drawer.
 * Confirma y dispara el envío masivo de certificados por correo.
 */
@Component({
  selector: 'app-enviar-masivo-drawer',
  standalone: true,
  ...
  template: `
    <app-drawer-form>
      ...
      <ng-container ngProjectAs="[drawer-form-footer]">
        <button class="btn-secondary" data-llm-action="cancel-bulk-email" (click)="drawer.close()">
          Cancelar
        </button>
        <button
...
export class EnviarMasivoDrawerComponent {
