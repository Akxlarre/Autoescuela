...
/**
 * HistorialEmisionesDrawerComponent — Smart / Drawer de solo lectura.
 * Lee `CertificacionClaseBFacade.log()` — sin inputs (LayoutDrawer no los soporta).
 */
@Component({
  selector: 'app-historial-emisiones-drawer',
  standalone: true,
...
export class HistorialEmisionesDrawerComponent {
