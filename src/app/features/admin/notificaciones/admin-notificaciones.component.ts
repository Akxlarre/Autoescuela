    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          ...
          <p class="text-sm text-text-muted mt-0.5">Mockup: /admin/notificaciones</p>
        </div>
      ...
      >
        ...
        <code class="text-xs text-text-muted"> mock/web/src/pages/admin/notificaciones.astro </code>
      </div>
    </div>
  `,
})
