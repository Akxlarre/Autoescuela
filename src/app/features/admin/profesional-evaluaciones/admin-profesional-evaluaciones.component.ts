  ...
  styles: [
    `
      /* ── Gradebook ────────────────────────────────────────────────
         ...
         crosshair de columna en hover (puro CSS vía ::after extendido). */
      .gradebook-scroll {
        max-height: 62vh;
        overflow: auto;
      }
  ...
  template: `
    <div class="bento-grid" appBentoGridLayout #bentoGrid>
      ...
      @if (!facade.grilla()) {
        ...
        <!-- Grupos de promoción con tarjetas de curso -->
      ...
      <!-- ═══ Botón volver (cuando hay grilla) ═══ -->
