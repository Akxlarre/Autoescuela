  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Agenda Semanal</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /admin/agenda</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mockup/web/src/pages/admin/agenda.astro
        </code>
      </div>
    </div>
  `,
