...
@Component({
  selector: 'app-relator-asistencia',
    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          ...
          <p class="text-sm text-text-muted mt-0.5">Mockup: /relator/asistencia</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs text-text-muted"> mock/web/src/pages/relator/asistencia.astro </code>
      </div>
    </div>
  `,
})
export class RelatorAsistenciaComponent {}
