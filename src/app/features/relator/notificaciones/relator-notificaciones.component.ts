...
@Component({
    selector: 'app-relator-notificaciones',
    ...
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          ...
          <p class="text-sm text-text-muted mt-0.5">Mockup: /relator/notificaciones</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs" style="color: var(--text-muted)">
          mock/web/src/pages/relator/notificaciones.astro
        </code>
      </div>
    </div>
  `,
})
export class RelatorNotificacionesComponent { }
