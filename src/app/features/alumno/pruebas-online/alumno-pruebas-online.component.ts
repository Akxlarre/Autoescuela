...
@Component({
  ...
  imports: [BentoGridLayoutDirective, CardHoverDirective, SectionHeroComponent, IconComponent],
  template: `
          ...
          <div class="card p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
              @for (stat of classBStats; track stat.label) {
                <div class="card-tinted rounded-xl p-4 flex flex-col gap-1">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @for (sim of activeSimulators(); track sim.name) {
              <a
                ...
                class="card p-5 flex flex-col gap-3 no-underline"
                appCardHover
