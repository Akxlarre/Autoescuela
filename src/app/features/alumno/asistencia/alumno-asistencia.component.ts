  ...
  template: `
    <div class="p-6">
      <div class="flex items-center gap-3 mb-6">
        <div>
          <h1 class="text-2xl font-semibold text-text-primary">Mi Asistencia</h1>
          <p class="text-sm text-text-muted mt-0.5">Mockup: /alumno/asistencia</p>
        </div>
        <span
      ...
      >
        ...
        <code class="text-xs text-text-muted"> mockop/web/src/pages/alumno/asistencia.astro </code>
      </div>
    </div>
  `,
})
export class AlumnoAsistenciaComponent {}
