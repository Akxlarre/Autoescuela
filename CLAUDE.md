...
1. **DESCUBRIR:** Revisa `indices/COMPONENTS.md`, `indices/FACADES.md`, `indices/SERVICES.md`, `indices/DIRECTIVES.md`, `indices/DATABASE.md` y, si vas a tocar lógica de negocio/RLS/una query nueva, `indices/DOMAIN-GOTCHAS.md`. ¿Ya existe algo que resuelva parcial o totalmente el problema? Úsalo. **En Claude Code, el Discovery Gate te bloqueará si no lo haces.**
